...
See the source at [[file:adventofcode.user.js][adventofcode.user.js]].  [[https://github.com/winny-/aoc/blob/master/greasemonkey/adventofcode.user.js][Click here]] to install.
